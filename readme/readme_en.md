...
<table>
  <tr>
    <td align="center" width="50%">
      <a href="./readme_goypulse_en.md">
        <img src="../assets/goypulse.png" alt="GoyPulse" width="100%">
      </a>
      <br><strong><a href="./readme_goypulse_en.md">GoyPulse</a></strong>
      <br><sub>Utility • Watcher</sub>
      <br>Smart Markov-based autoreply engine.
      <br><a href="./readme_goypulse_en.md"><strong>Open README</strong></a>
    </td>
    <td align="center" width="50%">
      <a href="./readme_goysec_en.md">
        <img src="../assets/goysec.png" alt="GoySecurity" width="100%">
      </a>
      <br><strong><a href="./readme_goysec_en.md">GoySecurity</a></strong>
      <br><sub>Security</sub>
      <br>Module scanner before installation.
      <br><a href="./readme_goysec_en.md"><strong>Open README</strong></a>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
      <a href="./readme_qwencli_en.md">
        <img src="../assets/QwenCLI.png" alt="QwenCLI" width="100%">
      </a>
      <br><strong><a href="./readme_qwencli_en.md">QwenCLI</a></strong>
      <br><sub>CLI / AI • Watcher</sub>
      <br>AI module for chat and automation.
      <br><a href="./readme_qwencli_en.md"><strong>Open README</strong></a>
    </td>
    <td align="center" width="50%">
      <a href="./readme_codexcli_en.md">
        <img src="../assets/CodexCLI.png" alt="CodexCLI" width="100%">
      </a>
      <br><strong><a href="./readme_codexcli_en.md">CodexCLI</a></strong>
      <br><sub>CLI / AI • Watcher</sub>
      <br>Codex-focused dev workflow module.
      <br><a href="./readme_codexcli_en.md"><strong>Open README</strong></a>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
      <a href="./readme_omniload_en.md">
        <img src="../assets/omniload.png" alt="OmniLoad" width="100%">
      </a>
      <br><strong><a href="./readme_omniload_en.md">OmniLoad</a></strong>
      <br><sub>CLI / Tools</sub>
      <br>Fast media downloader by link.
      <br><a href="./readme_omniload_en.md"><strong>Open README</strong></a>
    </td>
    <td align="center" width="50%">
      <a href="./readme_recon_en.md">
        <img src="../assets/recon.png" alt="Recon" width="100%">
      </a>
      <br><strong><a href="./readme_recon_en.md">Recon</a></strong>
      <br><sub>Security / OSINT</sub>
      <br>Recon and infra overview toolkit.
      <br><a href="./readme_recon_en.md"><strong>Open README</strong></a>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
      <a href="./readme_keyscanner_en.md">
        <img src="../assets/keyscanner.png" alt="KeyScanner" width="100%">
      </a>
      <br><strong><a href="./readme_keyscanner_en.md">KeyScanner</a></strong>
      <br><sub>Security • Watcher</sub>
      <br>API key scanner and validator.
      <br><a href="./readme_keyscanner_en.md"><strong>Open README</strong></a>
    </td>
    <td align="center" width="50%">
      <a href="./readme_ytmusic_en.md">
        <img src="../assets/ytmusic.png" alt="YTMusic" width="100%">
      </a>
      <br><strong><a href="./readme_ytmusic_en.md">YTMusic</a></strong>
      <br><sub>Music</sub>
      <br>YouTube tracks and playlists.
      <br><a href="./readme_ytmusic_en.md"><strong>Open README</strong></a>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
      <a href="./readme_soundcloudmusic_en.md">
        <img src="../assets/soundcloudmusic.png" alt="SoundCloudMusic" width="100%">
      </a>
      <br><strong><a href="./readme_soundcloudmusic_en.md">SoundCloudMusic</a></strong>
      <br><sub>Music</sub>
      <br>SoundCloud search and local playlists.
      <br><a href="./readme_soundcloudmusic_en.md"><strong>Open README</strong></a>
    </td>
    <td align="center" width="50%">
      <a href="./readme_doom_en.md">
        <img src="../assets/doom.png" alt="Doom" width="100%">
      </a>
      <br><strong><a href="./readme_doom_en.md">Doom</a></strong>
      <br><sub>Fun</sub>
      <br>DOOM mini-game inside Telegram.
      <br><a href="./readme_doom_en.md"><strong>Open README</strong></a>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
      <a href="./readme_goyvirus_en.md">
        <img src="../assets/goyvirus.png" alt="GoyVirus" width="100%">
      </a>
      <br><strong><a href="./readme_goyvirus_en.md">GoyVirus</a></strong>
      <br><sub>Fun / Utility</sub>
      <br>Humorous prank module.
      <br><a href="./readme_goyvirus_en.md"><strong>Open README</strong></a>
    </td>
    <td width="50%"></td>
  </tr>
</table>
