...
English docs are now in the modular structure.

- [Open full English README](./readme/readme_en.md)

## License
Documentation is protected under **GNU AGPLv3**. Details: [LICENSE](./LICENSE).
