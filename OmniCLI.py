...
# authors: @goymodules
# Description: OmniCLI unified multi-backend AI assistant module for Heroku.
# meta banner: https://raw.githubusercontent.com/sepiol026-wq/goypulse/main/assets/omnicli.png
...
DB_HISTORY_KEY = "omnicli_conversations_v1\u200b"
DB_GAUTO_HISTORY_KEY = "omnicli_auto_conversations_v1\u200b"
DB_IMPERSONATION_KEY = "omnicli_impersonation_chats"
DB_PRESETS_KEY = "omnicli_prompt_presets"
DB_MEMORY_DISABLED_KEY = "omnicli_memory_disabled_chats"
DB_AUTOMOD_CHATS_KEY = "omnicli_automod_chats"
...
OMNI_STREAM_BUFFER_LIMIT = 120
OMNI_STATUS_UPDATE_INTERVAL_DEFAULT = 2.0
OMNI_STATUS_UPDATE_INTERVAL_STREAMING = 1.25
OMNI_MAX_HISTORY_MESSAGES = 16
OMNI_MAX_HISTORY_ENTRY_CHARS = 1200
OMNI_MAX_PROMPT_TEXT_CHARS = 12000
OMNI_DEFAULT_MAX_SESSION_TURNS = 12
...
class OmniRequestInterrupted(Exception):
    pass
...
class OmniCLI(loader.Module):
    ...
    strings = {
        ...
        "cfg_proxy_doc": "Прокси для Omni CLI. Формат: http://user:pass@host:port",
        ...
        "cfg_chat_recording_doc": "Разрешить Omni CLI сохранять свои session records в runtime-home.",
        "cfg_approval_mode_doc": "Режим подтверждений Omni CLI: default (все действия с инлайн-подтверждением), plan (подтверждение только рискованных действий), auto-edit (авторазрешение редактирования/чтения, подтверждение shell/network/telegram), yolo (всё без подтверждений).",
        "cfg_max_concurrent_requests_doc": "Максимум одновременно выполняемых Omni CLI запросов.",
        "cfg_auto_bootstrap_doc": "Автоматически пытаться установить локальные Node.js и Omni CLI в user-space при отсутствии бинарника.",
        ...
        "request_busy_global": "<tg-emoji emoji-id=5409235172979672859>⚠️</tg-emoji> <b>Omni CLI сейчас занят другим запросом.</b> Попробуйте чуть позже.",
        "generic_error": "<tg-emoji emoji-id=5332431395266524007>❗️</tg-emoji> <b>Ошибка:</b>\n<code>{}</code>",
        "bootstrap_done": "<tg-emoji emoji-id=5330561907671727296>✅</tg-emoji> <b>Локальный Omni CLI подготовлен.</b>",
        "bootstrap_verify_fail": "<tg-emoji emoji-id=5332431395266524007>❗️</tg-emoji> <b>Установка завершилась, но верификация Omni CLI не прошла.</b>\n<code>{}</code>",
        "omni_auth_running": "<tg-emoji emoji-id=5472308992514464048>🔐</tg-emoji> <b>Подготавливаю вход в Omni...</b>",
        "omni_auth_step": (
            "<tg-emoji emoji-id=5472308992514464048>🔐</tg-emoji> <b>Вход в Omni</b>\n\n"
            "1. Откройте ссылку:\n<code>{}</code>\n\n"
            "2. Войдите в аккаунт и подтвердите доступ.\n\n"
            "<i>Я дождусь подтверждения автоматически.</i>"
        ),
        "omni_auth_done": "<tg-emoji emoji-id=5330561907671727296>✅</tg-emoji> <b>Omni OAuth успешно авторизован.</b>",
        "omni_auth_failed": "<tg-emoji emoji-id=5332431395266524007>❗️</tg-emoji> <b>Omni OAuth не завершился успешно.</b>\n<code>{}</code>",
        "omni_auth_already": "<tg-emoji emoji-id=5330561907671727296>✅</tg-emoji> <b>Omni OAuth уже настроен.</b>",
        ...
        "ompatch_usage": "<b>Использование:</b> <code>.ompatch &lt;что исправить/добавить&gt;</code>",
        ...
        "omni_files_only": "<tg-emoji emoji-id=5377844313575150051>📎</tg-emoji> <b>Omni создал файлы. Отправляю их ниже.</b>",
        "omni_file_caption": "<tg-emoji emoji-id=5377844313575150051>📎</tg-emoji> <b>Файл от Omni:</b> <code>{}</code>",
        "omni_status_title": "<tg-emoji emoji-id=5256079005731271025>📟</tg-emoji> <b>Omni в работе</b>{} · {}",
        "omni_status_phase": "{} <code>{}</code>",
        "omni_status_step": "<tg-emoji emoji-id=5249019346512008974>▶️</tg-emoji> шаг <code>{}</code> · <tg-emoji emoji-id=5253952855185829086>⚙️</tg-emoji> <code>{}с</code>",
        "omni_status_modes": "<tg-emoji emoji-id=5255989563037331120>➡️</tg-emoji> режимы: {}",
        "omni_status_tokens": "<tg-emoji emoji-id=5255713220546538619>💳</tg-emoji> токены: in <code>{}</code>{} / out <code>{}</code> / total <code>{}</code>",
        "omni_status_tool": "<tg-emoji emoji-id=5253952855185829086>⚙️</tg-emoji> инструмент: <code>{}</code>{}",
        "omni_status_trace": "<tg-emoji emoji-id=5253490441826870592>🔗</tg-emoji> трассировка: <code>{}</code> → <code>{}</code> · событий <code>{}</code>",
        "omni_status_activity": "<tg-emoji emoji-id=5253961389285845297>📌</tg-emoji> активность: <code>{}</code>",
        "omni_status_stream": "<tg-emoji emoji-id=5424885441100782420>📝</tg-emoji> поток: символов <code>{}</code> · tools <code>{}</code>",
        "omni_status_thought": "<tg-emoji emoji-id=5253590213917158323>💬</tg-emoji> мысли: <code>{}</code>",
        "omni_status_action": "<tg-emoji emoji-id=5253952855185829086>⚙️</tg-emoji> действие: <code>{}</code>",
        "omni_status_final_error": "<tg-emoji emoji-id=5350470691701407492>⛔</tg-emoji> ошибка: <code>{}</code>",
        "omclear_usage": "<tg-emoji emoji-id=5278753302023004775>ℹ️</tg-emoji> <b>Использование:</b> <code>.omclear [auto]</code>",
        "omreset_usage": "<tg-emoji emoji-id=5278753302023004775>ℹ️</tg-emoji> <b>Использование:</b> <code>.omreset [auto]</code>",
        "omsend_usage": "ℹ️ Использование: .omsend <@username/id> <текст>",
        "omchatinfo_usage": "ℹ️ Использование: .omchatinfo [id/@username]",
        "omme_usage": "ℹ️ Использование: .omme — информация об аккаунте",
        "omsend_sent": "<tg-emoji emoji-id=5255813619702049821>✅</tg-emoji> Сообщение отправлено в чат: {}",
        ...
        "auto_mode_usage": "<tg-emoji emoji-id=5278753302023004775>ℹ️</tg-emoji> <b>Использование:</b> <code>.omauto on/off</code> или <code>.omauto [id/username] on/off</code>",
        "auto_chance_usage": "<tg-emoji emoji-id=5278753302023004775>ℹ️</tg-emoji> <b>Использование:</b> <code>.omchance [0-100|0-1]</code>",
        ...
        "omch_usage": "<tg-emoji emoji-id=5278753302023004775>ℹ️</tg-emoji> <b>Использование:</b>\n<code>.omch &lt;кол-во&gt; &lt;вопрос&gt;</code>\n<code>.omch &lt;id чата&gt; &lt;кол-во&gt; &lt;вопрос&gt;</code>",
        "omch_processing": "<tg-emoji emoji-id=5332688668102525212>⌛️</tg-emoji> <b>Анализирую {} сообщений...</b>",
        "omch_result_caption": "Анализ последних {} сообщений",
        "omch_result_caption_from_chat": "Анализ последних {} сообщений из чата <b>{}</b>",
        "omch_chat_error": "<tg-emoji emoji-id=5332431395266524007>❗️</tg-emoji> <b>Ошибка доступа к чату</b> <code>{}</code>: <i>{}</i>",
        "omprompt_usage": "<tg-emoji emoji-id=5278753302023004775>ℹ️</tg-emoji> <b>Использование:</b>\n<code>.omprompt &lt;текст/пресет&gt;</code> — установить.\n<code>.omprompt -c</code> — очистить.\n<code>.ompresets</code> — база пресетов.",
        "omprompt_updated": "<tg-emoji emoji-id=5330561907671727296>✅</tg-emoji> <b>Системный промпт обновлен.</b>\nДлина: {} символов.",
        "omprompt_cleared": "<tg-emoji emoji-id=5370872568041471196>🗑</tg-emoji> <b>Системный промпт очищен.</b>",
        "omprompt_current": "<tg-emoji emoji-id=5956561916573782596>📝</tg-emoji> <b>Текущий системный промпт:</b>",
        "omprompt_file_error": "<tg-emoji emoji-id=5332431395266524007>❗️</tg-emoji> <b>Ошибка чтения файла:</b> {}",
        "omprompt_file_too_big": "<tg-emoji emoji-id=5332431395266524007>❗️</tg-emoji> <b>Файл слишком большой</b> (лимит 1 МБ).",
        "omprompt_not_text": "<tg-emoji emoji-id=5332431395266524007>❗️</tg-emoji> Это не похоже на текстовый файл.",
        "ommodel_usage": "<tg-emoji emoji-id=5278753302023004775>ℹ️</tg-emoji> <b>Использование:</b> <code>.ommodel [модель]</code> или <code>.ommodel -s</code>",
        "omauth_usage": (
        ...
        "ompresets_usage": (
            ...
            "• <code>.ompresets save [Имя] текст</code> — сохранить.\n"
            "• <code>.ompresets load 1</code> или <code>имя</code> — загрузить.\n"
            "• <code>.ompresets del 1</code> или <code>имя</code> — удалить.\n"
            "• <code>.ompresets list</code> — список."
        ),
        "ompreset_loaded": "<tg-emoji emoji-id=5330561907671727296>✅</tg-emoji> <b>Установлен пресет:</b> [<code>{}</code>]\nДлина: {} симв.",
        "ompreset_saved": "<tg-emoji emoji-id=5872695159631647090>💾</tg-emoji> <b>Пресет сохранен.</b>\n<tg-emoji emoji-id=5253961389285845297>📌</tg-emoji> <b>Имя:</b> {}\n№ <b>Индекс:</b> {}",
        "ompreset_deleted": "<tg-emoji emoji-id=5370872568041471196>🗑</tg-emoji> <b>Пресет удален:</b> {}",
        "ompreset_not_found": "<tg-emoji emoji-id=5408830797513784663>🚫</tg-emoji> Пресет с таким именем или индексом не найден.",
        "ompreset_list_head": "<tg-emoji emoji-id=5256230583717079814>📋</tg-emoji> <b>Ваши пресеты:</b>\n",
        "ompreset_empty": "<tg-emoji emoji-id=5872695159631647090>💾</tg-emoji> Список пресетов пуст.",
        "unsupported_media": "<tg-emoji emoji-id=5409235172979672859>⚠️</tg-emoji> <b>Этот тип медиа пока не поддерживается для Omni CLI:</b> <code>{}</code>",
        ...
        "status_omni": "• Omni CLI: {}",
        "status_model": "• Модель: <code>{}</code>",
        "status_set": "настроен",
        "status_missing": "не настроен",
        "status_ready": "готов",
        "status_not_ready": "не готов",
        "prod_status_title": "<tg-emoji emoji-id=5256230583717079814>📋</tg-emoji> <b>OmniCLI production status</b>",
        "prod_status_line": "• {}: <code>{}</code>",
        "automod_usage": "<b>Использование:</b> <code>.omamod on|off|status|rules &lt;текст&gt;|clear</code>",
        ...
        "cfg_check_title": "<tg-emoji emoji-id=5256230583717079814>📋</tg-emoji> <b>OmniCLI cfg-check</b>",
        "omni_models_note": (
        ...
        "resource_profile_usage": "<b>Использование:</b> <code>.omperf off|medium|max</code>",
    ...
    _RESOURCE_PROFILES = {
        ...
        "max": {
            ...
            "heap_mb": 768,
            "minimal_runtime_settings": True,
            "history_messages": OMNI_MAX_HISTORY_MESSAGES,
            "history_entry_chars": OMNI_MAX_HISTORY_ENTRY_CHARS,
            "prompt_text_chars": OMNI_MAX_PROMPT_TEXT_CHARS,
        },
    }
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            loader.ConfigValue(
                "omni_path",
                "",
                self.strings["cfg_omni_path_doc"],
                validator=loader.validators.String(),
            ),
            loader.ConfigValue(
                "omni_model",
                "coder-model",
                self.strings["cfg_omni_model_doc"],
                validator=loader.validators.String(),
            ),
            loader.ConfigValue(
                "selected_backend",
            ...
            loader.ConfigValue(
                "backend_paths",
                "",
                "JSON-карта backend->путь к CLI бинарнику.",
                validator=loader.validators.String(),
            ),
            loader.ConfigValue(
                "auth_type",
    ...
    async def client_ready(self, client, db):
        ...
        self.backend_auth_state = dict(
            self.db.get(self.strings["name"], DB_BACKEND_AUTH_KEY, {})
        )
    ...
    @loader.command()
    async def om(self, message: Message):
        """[текст или reply] — спросить у Omni CLI."""
    ...
    @loader.command()
    async def omstop(self, message: Message):
    ...
    @loader.command()
    async def ompatch(self, message: Message):
        """<текст> — остановить активный запрос и перезапустить с правкой."""
        await self._sync_runtime_config()
        patch_text = utils.get_args_raw(message).strip()
        if not patch_text:
            return await self._answer_html(message, self.strings["ompatch_usage"])
    ...
    @loader.command()
    async def omperf(self, message: Message):
    ...
    @loader.command()
    async def omprod(self, message: Message):
        ...
        runtime_dir = self._get_user_omni_dir()
        lines = [self.strings["prod_status_title"]]
        lines.append(self.strings["prod_status_line"].format("version", ".".join(map(str, __version__))))
        lines.append(self.strings["prod_status_line"].format("omni_ready", "yes" if ready else "no"))
        lines.append(self.strings["prod_status_line"].format("backend", backend))
    ...
    @loader.command()
    async def ommod(self, message: Message):
    ...
    @loader.command()
    async def omcfgcheck(self, message: Message):
        ...
        out.extend(
            [
                f"• <tg-emoji emoji-id=5253490441826870592>🔗</tg-emoji> <code>selected_backend</code>: <b>{utils.escape_html(self._get_selected_backend())}</b>",
                ...
                f"• <tg-emoji emoji-id=5256079005731271025>📟</tg-emoji> <code>omni_model</code>: <b>{utils.escape_html(self.config['omni_model'] or 'coder-model')}</b>",
    ...
    @loader.command()
    async def omauth(self, message: Message):
        ...
        action = parts[0].lower()
        if action == "clear":
            backend = (parts[1].strip().lower() if len(parts) > 1 else self._get_selected_backend())
            if backend == "all":
                done = []
                for item in SUPPORTED_OMNI_BACKENDS:
                    self.backend_auth_state.pop(item, None)
                    done.append(item)
                self.db.set(self.strings["name"], DB_BACKEND_AUTH_KEY, self.backend_auth_state)
                return await self._answer_html(message, f"Авторизация очищена: <code>{', '.join(done)}</code>")
            with contextlib.suppress(Exception):
                os.unlink(os.path.join(self._get_user_omni_dir(), "oauth_creds.json"))
            self.backend_auth_state.pop(backend, None)
            self.db.set(self.strings["name"], DB_BACKEND_AUTH_KEY, self.backend_auth_state)
        ...
        await self._answer_html(message, self.strings["omauth_usage"])
    ...
    async def omch(self, message: Message):
        ...
        if not args_str:
            return await self._answer_html(message, self.strings["omch_usage"])
        ...
        status_msg = await self._answer_html(
            message, self.strings["omch_processing"].format(count)
        )
        try:
            ...
            return await self._answer_html(
                status_msg,
                self.strings["omch_chat_error"].format(
                    target_chat_id, e.__class__.__name__
                ),
            )
        except Exception as e:
            return await self._answer_html(
                status_msg, self.strings["omch_chat_error"].format(target_chat_id, e)
            )
        ...
        try:
            result = await self._run_omni_request(
                target_chat_id,
                payload,
                system_prompt=self.config["system_instruction"].strip() or None,
                history_override=[],
            )
            header = self.strings["omch_result_caption_from_chat"].format(
                count, chat_name
            )
    ...
    @loader.command()
    async def omprompt(self, message: Message):
        ...
        if args == "-c":
            ...
            return await self._answer_html(message, self.strings["omprompt_cleared"])
        ...
        if preset:
            ...
            if reply.file.size > 1024 * 1024:
                return await self._answer_html(
                    message, self.strings["omprompt_file_too_big"]
                )
            try:
                ...
                try:
                    ...
                    return await self._answer_html(
                        message, self.strings["omprompt_not_text"]
                    )
            except Exception as e:
                return await self._answer_html(
                    message, self.strings["omprompt_file_error"].format(e)
                )
        elif args:
            new_prompt = args
        ...
        if new_prompt is not None:
            ...
            return await self._answer_html(
                message, self.strings["omprompt_updated"].format(len(new_prompt))
            )

        current_prompt = self.config["system_instruction"]
        if not current_prompt:
            return await self._answer_html(message, self.strings["omprompt_usage"])
        if len(current_prompt) > 4000:
            ...
            await self.client.send_file(
                message.chat_id,
                file=file,
                caption=self.strings["omprompt_current"],
            ...
            await self._answer_html(
                message,
                f"{self.strings['omprompt_current']}\n<code>{utils.escape_html(current_prompt)}</code>",
            )

    @loader.command()
    async def omauto(self, message: Message):
    ...
    async def omsend(self, message: Message):
        ...
        try:
            ...
            await self._answer_html(
                message, self.strings["omsend_sent"].format(title)
            )
        except Exception as e:
            await self._answer_html(
                message,
    ...
    @loader.command()
    async def omchatinfo(self, message: Message):
        """[id/@username] — информация о чате/пользователе."""
        await self._sync_runtime_config()
        raw = (utils.get_args_raw(message) or "").strip()
        if raw and len(raw.split()) > 1:
            return await self._answer_html(message, self.strings["omchatinfo_usage"])
        try:
            resolved = (
                int(raw)
    ...
    @loader.command()
    async def omme(self, message: Message):
        """— информация о текущем аккаунте."""
        await self._sync_runtime_config()
        me = self.me
        if not me:
            return await self._answer_html(message, self.strings["omme_usage"])
        bio = "—"
        with contextlib.suppress(Exception):
    ...
    @loader.command()
    async def omchance(self, message: Message):
    ...
    @loader.command()
    async def omautochats(self, message: Message):
    ...
    @loader.command()
    async def omclear(self, message: Message):
        ...
        await self._answer_html(message, self.strings["omclear_usage"])

    @loader.command()
    async def ompresets(self, message: Message):
        """<save/load/del/list> — управление пресетами."""
        await self._sync_runtime_config()
        args = utils.get_args_raw(message)
        if not args:
            return await self._answer_html(message, self.strings["ompresets_usage"])
        match = re.match(
        ...
        if action == "list":
            if not self.prompt_presets:
                return await self._answer_html(message, self.strings["ompreset_empty"])
            text = self.strings["ompreset_list_head"]
        ...
        if action == "save":
            if not name:
                return await self._answer_html(
                    message, "<tg-emoji emoji-id=5256054975389247793>📛</tg-emoji> Укажите имя: <code>.ompresets save [Имя] текст</code>"
                )
            reply = await message.get_reply_message()
            ...
            return await self._answer_html(
                message,
                self.strings["ompreset_saved"].format(name, len(self.prompt_presets)),
            )
        ...
        if action == "load":
            ...
            if not target:
                return await self._answer_html(
                    message, self.strings["ompreset_not_found"]
                )
            self.config["system_instruction"] = target["content"]
            return await self._answer_html(
                message,
                self.strings["ompreset_loaded"].format(
        ...
        if action == "del":
            ...
            self.db.set(self.strings["name"], DB_PRESETS_KEY, self.prompt_presets)
            return await self._answer_html(
                message, self.strings["ompreset_deleted"].format(target["name"])
            )

        await self._answer_html(message, self.strings["ompresets_usage"])

    @loader.command()
    async def ommemdel(self, message: Message):
    ...
    @loader.command()
    async def ommemchats(self, message: Message):
    ...
    @loader.command()
    async def ommemexport(self, message: Message):
        ...
        f.name = f"omnicli_{'auto_' if auto else ''}{src_id}.json"
    ...
    @loader.command()
    async def ommemimport(self, message: Message):
    ...
    @loader.command()
    async def ommemfind(self, message: Message):
    ...
    @loader.command()
    async def ommem(self, message: Message):
    ...
    @loader.command()
    async def ommemshow(self, message: Message):
    ...
    @loader.command()
    async def ommodel(self, message: Message):
        ...
        if not args_raw:
            return await self._answer_html(
                message,
                (
                    f"<tg-emoji emoji-id=5253490441826870592>🔗</tg-emoji> <b>Backend:</b> <code>{utils.escape_html(self._get_selected_backend())}</code>\n"
                    f"<tg-emoji emoji-id=5350445475948414299>🧠</tg-emoji> <b>Модель:</b> <code>{utils.escape_html(self.config['omni_model'] or 'coder-model')}</code>\n"
                    f"<tg-emoji emoji-id=5472308992514464048>🔐</tg-emoji> <b>Auth type:</b> <code>{utils.escape_html(self.config['auth_type'])}</code>"
                ),
            )
        if args_raw == "-s":
            return await self._answer_html(message, self.strings["omni_models_note"])
        if args_raw.startswith("backend "):
            backend = args_raw.split(maxsplit=1)[1].strip().lower()
            if backend not in SUPPORTED_OMNI_BACKENDS:
                return await self._answer_html(message, f"Доступные backend: <code>{', '.join(SUPPORTED_OMNI_BACKENDS)}</code>")
            self.config["selected_backend"] = backend
            return await self._answer_html(message, f"<b>Omni backend:</b> <code>{backend}</code>")
        self.config["omni_model"] = args_raw
        await self._answer_html(
            message,
            f"<tg-emoji emoji-id=5330561907671727296>✅</tg-emoji> <b>Omni model:</b> <code>{utils.escape_html(args_raw)}</code>",
        )

    @loader.command()
    async def omreset(self, message: Message):
    ...
    async def omnicli_callback_handler(self, call: InlineCall):
        if not call.data.startswith("omnicli:"):
            return
    ...
    async def watcher(self, message: Message):
        ...
        if getattr(message, "text", None):
            ...
            if stripped_text.startswith((".omauto", ".omchance", ".om", ".omauth")):
                return
        ...
        payload, warnings = await self._prepare_request_payload(message)
        if warnings:
            logger.warning("omauto warnings: %s", warnings)
        if not payload:
            return
    ...
    async def arbatch(self, chat_id: int):
        ...
        try:
            ...
            result = await self._run_omni_request_guarded(
                chat_id=chat_id,
        ...
        try:
            ...
            async def _show_embedded_tool_status(
                ...
                if impersonation_mode or not (call or status_msg):
                    return
                state = self._make_omni_progress_state(
                ...
                state["model"] = self.config["omni_model"]
                with contextlib.suppress(Exception):
                    await self._edit_processing_status(
                        call or status_msg,
                        self._format_omni_status(state),
                        chat_id=chat_id,
                        base_message_id=base_message_id,
                    )
            ...
            if not result_text:
                result_text = raw_result_text or (
                    self.strings["omni_files_only"] if generated_files else ""
                )
            if not result_text.strip():
                try:
                    ...
                    final_result = await self._run_omni_request_guarded(
                        chat_id=chat_id,
            ...
            if generated_files:
                await self._send_omni_generated_files(
                    chat_id, generated_files, reply_target_id
                )
        except OmniRequestInterrupted:
            ...
            if impersonation_mode:
                logger.error("omauto backend error: %s", error_text)
            elif call:
    ...
    def _extract_direct_send_tool_from_text(request_text: str):
        payload = OmniCLI._extract_direct_tool_from_text(request_text)
        if not isinstance(payload, dict):
            return None
    ...
    async def _run_omni_request_guarded(
        self,
        chat_id: int,
        payload: dict,
        ...
        if resource_profile.get("pre_cleanup"):
            try:
                ...
                logger.warning("Timed out while cleaning stale Omni/Node processes")
            except Exception:
                logger.exception("Pre-run Omni cleanup failed")
        session = self._request_sessions.get(chat_id) or {}
        if session.get("cancel_requested"):
            raise OmniRequestInterrupted(session.get("interrupt_reason") or "cancel")
        ...
        try:
            session = self._request_sessions.get(chat_id) or {}
            if session.get("cancel_requested"):
                raise OmniRequestInterrupted(
                    session.get("interrupt_reason") or "cancel"
                )
            return await self._run_omni_request(
                chat_id=chat_id,
                payload=payload,
                system_prompt=system_prompt,
                auto=auto,
    ...
    async def _run_omni_request(
        ...
        omni_path = self._get_omni_binary(backend)
        if not omni_path:
            raise RuntimeError(self.strings["omni_not_found"])
        ready, status = await self._get_omni_status_for_runtime(backend=backend)
        if not ready:
            raise RuntimeError(status or self.strings["omni_auth_missing"])

        selected_model = (self.config["omni_model"] or "coder-model").strip()
        prompt, file_specs = self._build_omni_prompt(
            chat_id,
            payload,
            system_prompt=system_prompt,
            auto=auto,
        ...
        async def _execute_once(heap_limit, prompt_override=None, file_specs_override=None, force_lean=False):
            ...
            with tempfile.TemporaryDirectory(prefix="omnicli_") as tempdir:
                ...
                progress_state = self._make_omni_progress_state(
                ...
                stdout_lines = deque(maxlen=OMNI_STREAM_BUFFER_LIMIT)
                stderr_lines = deque(maxlen=OMNI_STREAM_BUFFER_LIMIT)
                if session is not None:
                    session["proc"] = proc
                    session["request_id"] = request_id
                stdout_task = asyncio.create_task(
                    self._read_omni_stdout_stream(
                        proc.stdout,
                        stdout_lines,
                        progress_state,
                ...
                try:
                    while True:
                        ...
                        if (
                            ...
                            >= OMNI_STARTUP_TIMEOUT
                        ):
                            raise RuntimeError(
                                f"Omni CLI завис на старте и не выдал вывод за {OMNI_STARTUP_TIMEOUT} сек."
                            )
                        if now - progress_state["last_activity_at"] >= OMNI_TIMEOUT:
                            raise RuntimeError(
                                f"Omni CLI не подавал признаков жизни {OMNI_TIMEOUT} сек."
                            )
                ...
                if status_entity and not auto:
                    await self._update_omni_status_message(
                ...
                if not final_text and stdout_text:
                    final_text = stdout_text
                if proc.returncode != 0 and not final_text and not generated_files:
                    raise RuntimeError(
                        stderr_text
                        or stdout_text
                        or f"Omni не вернул ответ (код {proc.returncode})."
                    )
                if not final_text and not generated_files:
                    raise RuntimeError("Omni не вернул ответ. Попробуйте ещё раз.")
                with contextlib.suppress(Exception):
                    self._persist_omni_runtime_state(runtime_home)

            return {
                "text": final_text,
                "model": selected_model or "coder-model",
                "label": f"Omni CLI [{backend}]",
        ...
        try:
            ...
            if heap_mb and self._is_node_heap_oom(str(exc)):
                logger.warning(
                    "Omni CLI hit V8 heap limit at %s MB, retrying without heap cap",
                    heap_mb,
                )
                ...
                try:
                    ...
                    if not self._is_node_heap_oom(str(retry_exc)):
                        raise
                    logger.warning(
                        "Omni CLI still OOM without heap cap, retrying with compact context"
                    )
                    compact_prompt, compact_specs = self._build_omni_prompt(
                        chat_id,
                        payload,
                        system_prompt=system_prompt,
                        auto=auto,
    ...
    def _update_omni_progress_state(self, state: dict, payload: dict):
        ...
        if msg_type == "assistant":
            ...
            self._apply_omni_usage(state, usage)
        ...
        if msg_type == "result":
            ...
            self._apply_omni_usage(state, payload.get("usage") or {})
    ...
    def _apply_omni_usage(self, state: dict, usage: dict):
    ...
    async def _run_omni_device_auth(self, status_msg):
        ...
        try:
            ...
            with contextlib.suppress(Exception):
                await self._edit_html(
                    status_msg,
                    self.strings["omni_auth_step"].format(
            ...
            while asyncio.get_running_loop().time() < deadline:
                ...
                if token_response.get("access_token"):
                    ...
                    await self._cache_omni_credentials(credentials)
                    return True, "ok"
    ...
    async def _cache_omni_credentials(self, credentials: dict):
        ...
        path = os.path.join(omni_dir, "oauth_creds.json")
    ...
    def _format_omni_status(self, state: dict) -> str:
        ...
        if state["active_tool"]:
            ...
            tool_line = f"\n{self.strings['omni_status_tool'].format(utils.escape_html(state['active_tool']), exit_suffix)}"
        modes_line = ""
        ...
        if tags:
            ...
            modes_line = f"\n{self.strings['omni_status_modes'].format(formatted_tags)}"
        error_line = (
            f"\n{self.strings['omni_status_final_error'].format(utils.escape_html(state['final_error'][:160]))}"
            if state["final_error"]
            else ""
        )
        trace_line = self.strings["omni_status_trace"].format(
        ...
        activity_line = self.strings["omni_status_activity"].format(
            utils.escape_html(str(state.get("last_activity") or "idle"))
        )
        stream_line = self.strings["omni_status_stream"].format(
            self._fmt_num(state.get("final_text_chars") or len(state.get("final_text") or "")),
            self._fmt_num(len(state.get("tool_use_ids") or {})),
        )
        thought_line = self.strings["omni_status_thought"].format(
            utils.escape_html(self._short_status_text(state.get("thought_stream") or state.get("phase") or "—", limit=180)),
        )
        action_line = self.strings["omni_status_action"].format(
            utils.escape_html(self._short_status_text(state.get("action_stream") or state.get("active_tool") or "—", limit=180))
        )
        return (
            f"<blockquote>"
            f"{self.strings['omni_status_title'].format(session_suffix, '<code>' + utils.escape_html(state.get('model', '')) + '</code>' if state.get('model') else '')}\n"
            f"{self.strings['omni_status_phase'].format(phase_emoji, utils.escape_html(phase))} · "
            f"{self.strings['omni_status_step'].format(state['step'], elapsed)}\n"
            f"{self.strings['omni_status_tokens'].format(self._fmt_num(state['input_tokens']), cached_suffix, self._fmt_num(state['output_tokens']), self._fmt_num(state['total_tokens']))}"
            f"\n{trace_line}\n{activity_line}\n{stream_line}\n{thought_line}\n{action_line}"
            f"{modes_line}{tool_line}{error_line}"
            f"</blockquote>"
        )

    async def _update_omni_status_message(
        self, entity, state: dict, force: bool = False
    ):
        now = asyncio.get_running_loop().time()
        text = self._format_omni_status(state)
        min_interval = (
            OMNI_STATUS_UPDATE_INTERVAL_STREAMING
            if state.get("phase") in {"thinking", "writing answer", "running tool"}
            else OMNI_STATUS_UPDATE_INTERVAL_DEFAULT
        )
    ...
    @staticmethod
    def _append_limited_line(buffer, text: str, limit: int = OMNI_STREAM_BUFFER_LIMIT):
        buffer.append(text)
    ...
    def _extract_approval_details(self, payload: dict) -> dict:
        ...
        if payload.get("type") == "stream_event" and event.get("type") in {
            ...
            source = str(data.get("source") or "omni")
        return {
            "source": source,
    ...
    async def _request_action_approval(
        ...
        lines = [
            self.strings["approval_request_line"].format(
                "Источник", utils.escape_html(source or "omni")
            ),
            self.strings["approval_request_line"].format(
        ...
        try:
            ...
            return False
        try:
            decision = await asyncio.wait_for(fut, timeout=OMNI_TIMEOUT)
        except Exception:
            session.get("pending_approvals", {}).pop(uid, None)
            session["pending_approval_uid"] = None
            return False
    ...
    async def _handle_omni_approval_payload(self, chat_id: int, payload: dict, proc, status_entity, state: dict):
        msg_type = payload.get("type")
    ...
    async def _read_omni_stdout_stream(
        self,
        stream,
        stdout_lines: list,
        state: dict,
        ...
        while True:
            ...
            try:
                ...
                continue
            self._update_omni_progress_state(state, payload)
            if proc is not None and chat_id is not None:
                await self._handle_omni_approval_payload(
                    chat_id=chat_id,
                    payload=payload,
                    proc=proc,
                    status_entity=status_entity,
            ...
            if status_entity:
                await self._update_omni_status_message(status_entity, state)

    async def _read_omni_stderr_stream(self, stream, stderr_lines: list, state: dict):
        while True:
            line = await stream.readline()
            if not line:
                break
    ...
    def _collect_omni_generated_files(
    ...
    async def _send_omni_generated_files(
        self, chat_id: int, files: list, reply_to: int = None
    ):
        for file_info in files:
            file_obj = io.BytesIO(file_info["data"])
            file_obj.name = os.path.basename(file_info["name"]) or "omni_file"
            await self.client.send_file(
                chat_id,
                file=file_obj,
                caption=self.strings["omni_file_caption"].format(
    ...
    def _build_omni_prompt(
        ...
        if auto:
            lines = [
                ...
                "Не используй системные инструменты Omni CLI, не запускай команды и не меняй настройки.",
            ...
            lines = [
                ...
                "Если запрос требует действий в рабочей директории, используй инструменты Omni CLI и реально выполняй нужные шаги.",
    ...
    async def _execute_auto_actions(self, chat_id: int, trigger_message: Message, actions):
        ...
        for action in actions[:8]:
            ...
            try:
                ...
                logger.exception("OmniCLI auto action failed: %s", action_type)
    ...
    def _sanitize_auto_reply(self, text: str) -> str:
        ...
        cleaned = re.sub(
            r"^\s*(assistant|omni|ответ|reply|final|analysis|thinking)\s*:\s*",
            "",
            cleaned,
            flags=re.IGNORECASE,
        )
    ...
    def _get_bootstrap_base_dir(self):
        ...
        if os.name == "nt":
            ...
            return os.path.join(base, "OmniCLI")
        if xdg_data_home:
            return os.path.join(xdg_data_home, "omnicli")
        return os.path.join(home, ".local", "share", "omnicli")

    def _get_local_node_dir(self):
        return os.path.join(self._get_bootstrap_base_dir(), "node")

    def _get_local_omni_prefix(self, backend: str = None):
        backend = (backend or self._get_selected_backend()).strip().lower()
        return os.path.join(self._get_bootstrap_base_dir(), backend)
    ...
    def _get_local_omni_binary(self, backend: str = None):
        backend = (backend or self._get_selected_backend()).strip().lower()
        base = self._get_backend_bin_name(backend)
        name = f"{base}.cmd" if os.name == "nt" else base
        return os.path.join(self._get_local_omni_prefix(backend), "bin", name)
    ...
    async def _ensure_omni_cli_available(self, force: bool = False, backend: str = None):
        backend = (backend or self._get_selected_backend()).strip().lower()
        ...
        if not force:
            ...
            if self._get_omni_binary(backend):
                self._pin_detected_omni_path(backend)
                return
        ...
        async with self._install_lock:
            if not force and os.path.isfile(local_omni):
                ...
                self._set_backend_path(backend, local_omni)
                return
            if not force and self._get_omni_binary(backend):
                self._pin_detected_omni_path(backend)
                return
    ...
    async def _ensure_local_node(self):
        ...
        with tempfile.TemporaryDirectory(prefix="omni_node_") as tempdir:
    ...
    async def _ensure_local_omni_cli(self, backend: str = None):
        backend = (backend or self._get_selected_backend()).strip().lower()
        omni_bin = self._get_local_omni_binary(backend)
        if os.path.isfile(omni_bin):
            return
        node_bin = self._get_local_node_binary()
        ...
        prefix = self._get_local_omni_prefix(backend)
        os.makedirs(prefix, exist_ok=True)
        env = self._build_subprocess_env()
        path_parts = [
            os.path.dirname(node_bin),
            os.path.dirname(omni_bin),
            env.get("PATH", ""),
        ]
        ...
        proc = await asyncio.create_subprocess_exec(
            ...
            "install",
            "-g",
            self._get_backend_package(backend),
            "--prefix",
            prefix,
            stdout=asyncio.subprocess.PIPE,
            stderr=asyncio.subprocess.PIPE,
        ...
        if proc.returncode != 0:
            raise RuntimeError(
                ...
                or f"Не удалось установить backend {backend}."
            )
        self._chmod_tree(prefix)
        if not os.path.isfile(omni_bin):
            raise RuntimeError(f"Установка завершилась без binary backend {backend}.")

    async def _verify_omni_installation(self, backend: str = None):
        backend = (backend or self._get_selected_backend()).strip().lower()
        omni_bin = self._get_omni_binary(backend)
        if not omni_bin:
            return False, "binary not found"
        env = self._build_subprocess_env()
        for argv in ([omni_bin, "--version"], [omni_bin, "--help"]):
            proc = await asyncio.create_subprocess_exec(
                *argv,
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE,
    ...
    def _read_url_bytes(self, url: str) -> bytes:
        headers = {"User-Agent": "OmniCLI-Bootstrap/1.0 (Core by @samsepi0l_ovf; AGPLv3)"}
    ...
    def _post_form_json(self, url: str, data: dict) -> dict:
        headers = {
            "User-Agent": "OmniCLI-Bootstrap/1.0 (Core by @samsepi0l_ovf; AGPLv3)",
    ...
    def _build_subprocess_env(self, heap_override=None):
        ...
        local_paths = [
            ...
            os.path.dirname(self._get_local_omni_binary()),
        ]
    ...
    def _is_omni_related_process(
        ...
        local_omni = os.path.abspath(self._get_local_omni_binary()).lower()
        omni_binary = self._get_omni_binary()
        omni_binary = os.path.abspath(omni_binary).lower() if omni_binary else ""
        ...
        if omni_binary:
            omni_markers.append(omni_binary)

        return any(marker in haystack for marker in process_markers) and any(
            marker and marker in haystack for marker in omni_markers
        )
    ...
    async def _kill_zombie_processes(self):
            ...
            with contextlib.suppress(Exception):
                for proc in psutil.process_iter(["pid", "name", "exe", "cmdline", "cwd"]):
                    ...
                    if not pid or pid == current_pid or pid in active_pids:
                        continue
                    info = proc.info
                    if self._is_omni_related_process(
        ...
        logger.warning("Cleaning up stale Omni/Node processes: %s", sorted(stale_pids))
    ...
    def _set_backend_path(self, backend: str, path: str):
        mapping = self._get_backend_paths_map()
        if path:
            mapping[backend] = path
        else:
            mapping.pop(backend, None)
        self.config["backend_paths"] = json.dumps(mapping, ensure_ascii=False)

    def _get_backend_path(self, backend: str) -> str:
        mapping = self._get_backend_paths_map()
    ...
    def _iter_omni_binary_candidates(self, backend: str = None):
        backend = (backend or self._get_selected_backend()).strip().lower()
        configured = self._get_backend_path(backend) or self.config["omni_path"].strip()
        if configured:
            yield configured
        yield self._get_local_omni_binary(backend)
        if os.name == "nt":
            base = self._get_backend_bin_name(backend)
            for name in [f"{base}.exe", f"{base}.cmd", f"{base}.bat", base]:
                yield name
        else:
            yield self._get_backend_bin_name(backend)
        home = os.path.expanduser("~")
        user_local_bin = os.path.join(home, ".local", "bin")
        user_bin = os.path.join(home, "bin")
        npm_prefix_bin = os.path.join(home, ".npm-global", "bin")
        candidates = [
            os.path.join(user_local_bin, self._get_backend_bin_name(backend)),
            os.path.join(user_bin, self._get_backend_bin_name(backend)),
            os.path.join(npm_prefix_bin, self._get_backend_bin_name(backend)),
            os.path.join(user_local_bin, f"{self._get_backend_bin_name(backend)}.cmd"),
            os.path.join(user_bin, f"{self._get_backend_bin_name(backend)}.cmd"),
            os.path.join(npm_prefix_bin, f"{self._get_backend_bin_name(backend)}.cmd"),
        ]
        appdata = os.environ.get("APPDATA")
        if appdata:
            candidates.extend(
                [
                    os.path.join(appdata, "npm", f"{self._get_backend_bin_name(backend)}.cmd"),
                    os.path.join(appdata, "npm", self._get_backend_bin_name(backend)),
                ]
            )
    ...
    def _get_omni_binary(self, backend: str = None):
        backend = (backend or self._get_selected_backend()).strip().lower()
        seen = set()
        for candidate in self._iter_omni_binary_candidates(backend):
    ...
    def _prepare_omni_runtime_home(self, tempdir: str) -> str:
        ...
        for name in [
            ...
            src = os.path.join(source_omni, name)
            dst = os.path.join(runtime_omni, name)
            if os.path.exists(src):
                with open(src, "rb") as src_f, open(dst, "wb") as dst_f:
                    dst_f.write(src_f.read())
        for system_name in ("system-settings.json", "system-defaults.json"):
            system_path = os.path.join(runtime_omni, system_name)
        ...
        if not resource_profile.get("minimal_runtime_settings"):
            settings = {}
            settings_path = os.path.join(source_omni, "settings.json")
            ...
            with open(
                os.path.join(runtime_omni, "settings.json"), "w", encoding="utf-8"
            ) as file_obj:
        ...
        settings = {
            ...
            "model": {
                "name": (self.config["omni_model"] or "coder-model").strip(),
                "maxSessionTurns": OMNI_DEFAULT_MAX_SESSION_TURNS,
    ...
    def _normalize_runtime_settings(self, settings):
        ...
        model["name"] = (self.config["omni_model"] or "coder-model").strip()
        current_turns = model.get("maxSessionTurns")
        if not isinstance(current_turns, int) or current_turns < 2:
            model["maxSessionTurns"] = OMNI_DEFAULT_MAX_SESSION_TURNS
    ...
    def _persist_omni_runtime_state(self, runtime_home: str):
        ...
        os.makedirs(target_omni, exist_ok=True)
        for name in [
            "oauth_creds.json",
            "installation_id",
            "google_accounts.json",
            ...
            src = os.path.join(runtime_omni, name)
            dst = os.path.join(target_omni, name)
    ...
    async def _get_omni_status_for_runtime(self, backend: str = None):
        backend = (backend or self._get_selected_backend()).strip().lower()
        await self._ensure_omni_cli_available(backend=backend)
        if not self._get_omni_binary(backend):
            return False, self.strings["omni_not_found"]
    ...
    async def _format_auth_status(self):
        ...
        out.append(f"• Backend: <code>{backend}</code>")
        out.append(
        ...
        out.append(
            self.strings["status_model"].format(
                utils.escape_html(self.config["omni_model"] or "coder-model")
            )
        )
    ...
    def _handle_error(self, e: Exception) -> str:
        logger.exception("OmniCLI execution error")
        msg = str(e)
        if msg.startswith(
    ...
    async def _resolve_cfg_chat_values(self, raw: str):
        ...
        for item in self._split_cfg_chat_values(raw):
            ...
            try:
                ...
                logger.warning(
                    "OmniCLI: не удалось разрешить chat target из cfg: %s", item
                )
        return resolved
    ...
    async def _render_page(self, uid, page_num, entity):
        ...
        nav_row = []
        if page_num > 0:
            nav_row.append({"text": "◀️", "data": f"omnicli:pg:{uid}:{page_num - 1}"})
        nav_row.append({"text": f"{page_num + 1}/{total}", "data": "omnicli:noop"})
        if page_num < total - 1:
            nav_row.append({"text": "▶️", "data": f"omnicli:pg:{uid}:{page_num + 1}"})
        extra_row = [
